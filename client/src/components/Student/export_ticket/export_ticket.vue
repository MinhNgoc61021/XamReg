      ...
      <b-table
        ...
        :bordered="true">
          <template slot-scope="props">
            ...
            <b-table-column field="SubjectTitle" label="Tên môn thi">
              {{ props.row.Shift.Subject.SubjectTitle }}
            </b-table-column>
            <b-table-column field="RoomName" label="Phòng thi">
              {{ props.row.Exam_Room.RoomName}}
            </b-table-column>
            <b-table-column field="Maxcapacity" label="Số chỗ">
              {{ props.row.Exam_Room.Maxcapacity}}
            </b-table-column>
             <b-table-column field="Action" label="Thao tác" width="100">
